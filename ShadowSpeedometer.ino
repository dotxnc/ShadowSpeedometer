...
// the font https://github.com/raymond-w-ko/creep2
...
void draw(void)
{
    ...
    u8g.setFontLineSpacingFactor(4);
    ...
    // Show satellite connection strength
    static const int weak_width = (4*4+4)/2;
    static const int moderate_width = (4*8+8)/2;
    static const int strong_width = (4*6+6)/2;
    u8g.drawFrame(4, 35, 46, 11);
    if (gps.satellites.value() == 0)
        u8g.drawStr(27 - weak_width, 44, "None");
    else if (gps.satellites.value() < 3)
        u8g.drawStr(27 - weak_width, 44, "Weak");
    else if (gps.satellites.value() < 9)
        u8g.drawStr(27 - moderate_width, 44, "Moderate");
    else
        u8g.drawStr(27 - strong_width, 44, "Strong");
